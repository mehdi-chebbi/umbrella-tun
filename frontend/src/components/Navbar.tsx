...
import { Menu, X, Lock, Map } from 'lucide-react';
      ...
      >
        <div className="bg-black/95 backdrop-blur-md px-6 py-8 flex flex-col gap-6">
          ...
          <NavLink
            to="/geoportail"
            onClick={() => setIsOpen(false)}
            className="text-[11px] font-semibold uppercase tracking-[0.2em] text-white/70 hover:text-white transition-colors flex items-center gap-1.5"
          >
            <Map size={13} strokeWidth={1.5} />
            <span>Géoportail</span>
          </NavLink>
